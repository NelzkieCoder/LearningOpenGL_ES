...
/**
 * Created by skadush on 21/05/17.
 */
...
class LessonOneRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        InputStream is = context.getResources().openRawResource(R.raw.vertex);
        //String vertexShader = getStringFromInputStream(is);
        String vertexShader = getVertexShader();
        Log.d("IISS",vertexShader);
        ...
        is = context.getResources().openRawResource(R.raw.fragment);
        String fragmentShader = getStringFromInputStream(is);
